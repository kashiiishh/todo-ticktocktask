...
function page() {
  return (
    <GlobalStyleProvider>
      <HeroSection>
        <Heading>Welcome to our ToDo App: <span>"TickTockTask"</span></Heading>

        <img
          src="https://media4.giphy.com/media/UKubhTGTqVKrs321IQ/200w.gif?cid=6c09b9521rkv7wixtxjvppzch27u590k84xvujy0cv6yg40r&ep=v1_gifs_search&rid=200w.gif&ct=g"
          alt="ToDo App"
